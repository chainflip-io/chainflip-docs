...
If you *do* lose access to these keys, you can [recover your validator account](/berghain/validator-setup/keys#recovering-your-keys) and restore it to a state where it can participate in the network again.
...
- If you think the keys might be compromised, we recommend that you immediately secure your FLIP funds by [binding a redeem address](/perseverance/funding/advanced-account-management#redemption-execution-address-binding), [stopping your bid](/berghain/validator-setup/funding-and-bidding) and then, when your funds are unbonded, redeeming them to your wallet before staking a new node with new keys.
