...
<Callout type="info">
  The swap input is first denominated in USD. This always occurs at some stage
  in the swapping process as a function of [$USDC Denominated
  Pools](http://127.0.0.1:5000/s/DQUC2wQf4NIhgIHFhCFR/swaps-amm/usdusdc-denominated-pools
  "mention").
</Callout>
