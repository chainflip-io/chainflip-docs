...
<Callout type="info">
The Just-In-Time (JIT) AMM was introduced to the protocol design on the Feb 2022. Check our blog post here: [Just in Time AMM](https://blog.chainflip.io/just-in-time-jit)
</Callout>
...
<Callout type="info">
  An open-source Python model of the JIT AMM is available on the [Chainflip GitHub](https://github.com/chainflip-io/chainflip-jit-amm-python) account.
</Callout>
