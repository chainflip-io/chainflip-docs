...
JIT Liquidity provisioning means that for the vast majority of users, we can offer extremely good pricing on large swaps without having to delay its execution and impact the user experience.
