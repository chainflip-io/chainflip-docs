  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td>
          <p>
            A validator node is considered <em>Qualified</em> if all of the following
          ...
          <ul>
            ...
            <li>
              <strong>Bidding is true</strong>.
            </li>
            <li>Bid is at least half of the current MAB</li>
            <li>It is running <em>at least</em> the minimum version of the Chainflip Engine</li>
          </ul>
        </td>
      </tr>
      <tr>
