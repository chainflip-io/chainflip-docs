...
For more detailed information on the implementation of the funding and redeeming features of the State Chain Gateway smart contract see [StateChain Gateway](../../integration/swapping-and-aggregation/evm-integration/statechain-gateway.mdx).