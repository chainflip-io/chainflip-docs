...
Welcome to Chainflip. The "Concepts" section breaks down the Chainflip protocol in a reasonably detailed manner, but only conceptually! We frequently update this entire site, including the [technical documentation](../perseverance/introduction.mdx) to assist you in setting up a Validator.
