...
In any case, the Security Ratio of 1:1 will be enforced by the validator network to prevent buildups of collateral not being fully utilised, although it should be noted that this feature is not yet implemented.
