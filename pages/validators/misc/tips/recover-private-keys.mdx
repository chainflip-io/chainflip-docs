...
description: If for whatever reason you lost your keys but still have access to your server, don't freak out (yet) and follow this page.
...
<Callout type="error">
  ...
  these keys can take all your `FLIP` added to your validator node**
</Callout>
...
Secret Key URI `0x` is account:
  ...
  Secret seed:       <YOUR SECRET SEED> # <-- Don't share it with anyone
