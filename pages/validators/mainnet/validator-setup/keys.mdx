...
You must ensure that the public Ethereum address generated above has at least **0.2 ETH** on Ethereum Mainnet and **0.1 ETH** on Ethereum Arbitrum. Any fees your validator pays will be refunded back to the same account at the end of an epoch. You should monitor this balance to ensure it doesn't fall below the required amount.
