...
You must ensure that the public Ethereum address generated above has at least **0.5 ETH** on Ethereum Mainnet and **0.3-1 ETH** on Ethereum Arbitrum. This requirement will change when the protocol is set up to refund validators on transaction fees. Currently, this number represents an overestimate until that change is implemented.
