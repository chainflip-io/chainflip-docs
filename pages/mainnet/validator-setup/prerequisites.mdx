...
<Callout type="warning">
  Note there is a **minimum funding requirement** for new Validator nodes: new nodes must have a balance of at least 10% of the current [Bond](oncepts/validator-network/validator-auctions-bonds-and-rewards#bonds). Please ensure you have access to enough FLIP to run a node before continuing this process.
</Callout>
