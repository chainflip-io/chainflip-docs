...
You have two options. By default, the command will redeem the maximum available funds from your account, taking into account the bond. For example, imagine your account balance is 1000 \$FLIP and the bond is 800 \$FLIP, the following would withdraw 795 \$FLIP net of tax, to the Ethereum account `0xcf..cf`:
...
A waiting period of **48 hours** before it can be used to redeem. This delay is a security measure to limit the risk in Chainflip's Vaults.
