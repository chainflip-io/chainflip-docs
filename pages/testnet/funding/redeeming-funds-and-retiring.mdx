...
description: You can redeem your precious tFLIP, subject to certain conditions. In order to do so, the funds may neither be bonded, nor tied up in auction bidding.
...
Deregistration is not possible until your account has stopped bidding and is no longer a key holder for an active Epoch (usually this implies that at least one Epoch has past since your account was last in the authority set).

See the section on [account roles](/pages/integration/account-roles) for more information.
