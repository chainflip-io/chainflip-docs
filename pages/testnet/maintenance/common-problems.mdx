...
Make sure you have at least **0.1 sETH** and 0.1 Sepolia ArbEth at all time in your validator's wallet. Otherwise you'll fail to submit transactions to external networks.
