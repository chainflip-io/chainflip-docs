...
You validator will need to have a balance of the native token of the EVM chain you are validating on. For example, for Ethereum you will to have ETH, for Arbitrum you will need to have ArbETH and so on. The recommended amount is 0.1 of the native token on each chain.
