...
This makes sure the user gets a satisfactory result for the swap or you get a refund.
For this reason, the protocol requires a refund address and a retry duration.
