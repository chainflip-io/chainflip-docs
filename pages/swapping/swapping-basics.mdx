...
While the protocol allows for dca parameters (number of chunks) to be set by the broker, the number of chunks can be adjusted internally to ensure a minimum size per chunk.
