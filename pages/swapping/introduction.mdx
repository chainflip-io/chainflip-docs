...
2. **Enable Integration:** Our documentation provides detailed instructions, practical code examples, and best practices for integrating the Chainflip Protocol into your projects using our [JavaScript SDK](integrations/javascript-sdk/introduction) and [API bundles](integrations/running-a-broker/broker-api). We cover everything from setting up your development environment to handling responses and errors.
...
Aggregation, in this context, involves combining multiple protocols for a route from asset A to asset B. This is made possible thanks to our [Cross-Chain Messaging (CCM)](integrations/advanced/cross-chain-messaging/cross-chain-messaging.mdx) feature, which allows partners to easily integrate with the Chainflip protocol. See our [How Swapping Works](how-swapping-works.md) to learn how it's done.
