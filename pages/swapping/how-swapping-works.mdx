...
2. **Witnessing the deposit:** The Validator network will monitor open [Deposit Channels](../../concepts/swaps-amm/deposit-channels-and-brokers) for incoming transactions. Upon seeing a deposit for a Swap, it will be witnessed and registered on the State Chain.
