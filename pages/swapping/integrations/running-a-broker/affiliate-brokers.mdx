...
# Affiliates
<Callout type="note">In version 1.8 we changed the way Affiliate brokers work. We stay backward compatible with the previous version and it is possible to withdraw your Affiliate commissions via the regular withdrawal flow for old Affiliate broker accounts.</Callout>
