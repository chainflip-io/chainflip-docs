...
The goal of this feature is to deliver a frictionless way to share commission with other parties that don't want to run a Broker API bundle themselves, 
but still want to benefit from the operation of a Broker by bringing them swaps and sharing the fees. A good example for this would be a Crypto-Influencer having a large audience and would like to promote 
Chainflip to his audience, but doesn't want to get his hands dirty with the technical operation of a Broker or even touching any kind of special software.
