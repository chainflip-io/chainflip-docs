...
Request an incoming transaction to be rejected. Only available for bitcoin currently. This call will always succeed, but the transaction will
...
Subscribes to all runtime events related to screening of transactions.
