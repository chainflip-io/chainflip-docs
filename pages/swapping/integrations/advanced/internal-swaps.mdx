...
Users that already have funds on Chainflip (currently limited to [liqiudity providers](../../../lp/introduction)) can initiate swaps (called "internal swaps") directly from their account balance.
