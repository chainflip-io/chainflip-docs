...
- The receiver on the destination chain needs to be a smart contract with the interface described for the destination chain, either [EVM](evm-ccm#receive-call-and-asset-on-the-receiver-contract) or [Solana](./sol-ccm#receive-call-and-asset-on-the-receiver-contract).
