...
| ----- | ----------- | --------- |
| source_chain | Source chain for the swap | u32 |
...
The user has to provide a gas budget for the destination chain that must cover the user's logic compute unit consumption on Solana. The Chainflip protocol subtract from the final destination amount the native asset amount needed to pay for the transaction costs, including the compute unit price.
...
export function newSolanaCcmAdditionalData() {
...
console.log(newSolanaCcmAdditionalData());
```
...
```bash
0x7417da8b99d7748127a76b03d61fee69c80dfef73ad2d5503737beedc5a9ed480104a73bdf31e341218a693b8772c43ecfcecd4cf35fada09a87ea0f860d028168e50090e0b0f5b60147b325842c1fc68f6c90fe26419ea7c4afeb982f71f1f54b5b44
```
