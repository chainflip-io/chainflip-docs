...
This section provides an overview on the interface. For actual examples and useful code on how to encode the data, refer to [**CCM support for Solana**](./additional_data.mdx#for-solana) for more info.
