...
**Upcoming upgrade on 1.8 release**: The gas budget will represent the amount of gas the destination chain instead. At the time of egress, Chainflip will take the minimum amount of the destination asset needed to cover the gas. This makes estimation simpler, cheaper and more reliable.
