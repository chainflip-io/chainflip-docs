...
6. The Chainflip protocol will then subtract from the final amount the native asset amount needed to pay for the gas costs of the transaction on the destination chain.
