...
The Chainflip-signed payload will be valid until two key rotations have taken place. On mainnet this is currently up to 6 days.
...
It is strongly encouraged to use try/catch statments to handle reverts in the receiver contract.
</Callout>
