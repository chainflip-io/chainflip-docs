...
// TODO: Update this with an updated response. Both data and accounts have changed.
```json
{
  "jsonrpc": "2.0",
  "result": {
...
// TODO: Add values instead of the parameter names so it can be copy pasted. This will also include how to derive the `eventDataAccount` PDA from the seeds.
