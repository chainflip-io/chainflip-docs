...
| `cfParameters`| Additional metadata for additional features. It cannot be empty and must be correctly encoded according to [Chainflip Parameters](./vault-swaps.mdx#chainflip-parameters-cf_parameters). | `Vec<u8>` |
