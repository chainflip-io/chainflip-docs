...
| cfParameters | Additional metadata for additional features. See  <a href="/TODO">TODO</a>. | `Vec<u8>` |
...
#### cf_parameters
TODO: give encoding spec for cf_parameters. This is relevant also for EVM manual swaps. TBD on where to put it.
