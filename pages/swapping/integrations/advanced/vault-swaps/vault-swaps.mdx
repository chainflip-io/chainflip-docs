...
Vault swaps support the same features as those initiated via [Deposit Channels](/pages/concepts/swaps-amm/deposit-channels-and-brokers.mdx#deposit-channels) but don't require a Broker to be initiated.

<Callout type="info">
Learn more in [How Swapping Works](/pages/swapping/how-swapping-works.mdx).
</Callout>
