...
TODO: Try this out, I think this will fail because ccm_additional_data should be empty when done to ETH. Change it to swap to SOL or set ccm_additional_data to empty.

To request a vault Swap with a CCM, the `ccm_additional_data` field must be filled. You can see an example below:
