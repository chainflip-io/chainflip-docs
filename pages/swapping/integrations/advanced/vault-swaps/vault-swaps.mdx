...
- A Vault Swap transaction is single-use, whereas deposit channels can be used multiple times once they opened.
...
- At the time of writing, Vault Swaps are not supported on Polkadot.
