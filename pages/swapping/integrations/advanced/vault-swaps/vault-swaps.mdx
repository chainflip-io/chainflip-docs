...
Traditionally, swaps initiated by Brokers involve requesting a deposit address and sending funds to that deposit address to initiate the swap. This page introduces a new way to initiate swaps on Chainflip by making a direct call to the Chainflip Vault.

Vault swaps support the same features as those initiated via [Deposit Channels](/concepts/swaps-amm/deposit-channels-and-brokers.mdx#deposit-channels) but don't require a Broker to be initiated.
