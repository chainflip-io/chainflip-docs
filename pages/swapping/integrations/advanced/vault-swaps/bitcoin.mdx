...
The Bitcoin network currently do not support CCMs. e.g. you cannot swap Btc into Eth with CCM attached.
...
## Example to encode, sign and send Bitcoin Vault Swap
