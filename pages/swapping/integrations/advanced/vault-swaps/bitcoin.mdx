...
1. Request [swap parameter encoding](#1-request-the-encoded-payload-via-rpc).
...
### 1. Request the encoded payload via RPC
...
const response = await fetch('http://my-chainflip-node:9944', {
  method: 'POST',
  headers: {
