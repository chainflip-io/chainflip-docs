...
Please note that address of the third output of the transaction (`change UTXO`) is used as refund address for the swap. The encoding is done using the following order:
