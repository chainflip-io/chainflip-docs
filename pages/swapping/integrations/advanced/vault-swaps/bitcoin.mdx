...
<Callout type="info">
The encoded data in `nulldata_payload` returned by [broker_request_swap_parameter_encoding](../../running-a-broker/broker-api#broker_request_swap_parameter_encoding) does not include any OP codes. 
Depending on how you build your transaction, you may need to add these manually. 
