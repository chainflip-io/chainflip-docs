...
#### Example RPC call
TODO: Add information with an example RPC call and response like in solana.mdx. Also adding the signing and broadcasting in typescript.
TODO: Add the signing and broadcasting in typescript like in Solana/EVM as part of the transaction construction.
