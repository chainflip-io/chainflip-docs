...
{<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Optional metadata for setting a <a href="/swapping/swapping-basics#slippage-protection">minimum accepted price</a> for swaps through the deposit channel. This allows to
    ...
    <tr>
      ...
      <td>
        Optional metadata for executing a swap through a deposit channel as a <a href="/swapping/swapping-basics#dollar-cost-average-dca-improving-price"> DCA swap</a>. Setting these params will split the swap into smaller chunks and execute them consecutively with a delay.
      </td>
      <td><code>Object</code></td>
    </tr>
  </tbody>
...
The optional `fillOrKillParams` object sets a [minimum accepted price](/swapping/swapping-basics#slippage-protection) for swaps triggered through the deposit channel.
