...
<Callout type="info">
  If you plan to implement [DCA](../../../swapping/swapping-basics.md#dollar-cost-average-dca-improving-price), using the new methods (v2) is required.
</Callout>
...
- [`requestDepositAddressV2()`](../swap-assets/request-deposit-address-v2.mdx)
