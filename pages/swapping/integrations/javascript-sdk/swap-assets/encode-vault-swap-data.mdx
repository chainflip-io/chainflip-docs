...
<table>
    ...
    <tr>
        ...
        <td>
            ...
            <ul>
                <li>
                    For swaps starting from Solana, <a href="../../advanced/vault-swaps/solana#user-created-event-data-account"><code>seed</code></a> can optionally be provided.
                    When a seed is not provided a random one will be generated on the fly.
                </li>
            </ul>
        </td>
        <td><code>string</code></td>
...
// TODO: Update this with an updated response. Data has changed (extra 32 bytes for the seed).
```typescript copy
// console output:
{
  chain: 'Solana',
