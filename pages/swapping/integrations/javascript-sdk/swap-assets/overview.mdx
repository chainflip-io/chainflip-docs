...
1. [**minimum accepted price**](/swapping/swapping-basics#minimum-accepted-price-slippage-protection)
...
2. [**live price protection**](/swapping/swapping-basics#oracle-swaps)
    ...
    This is especially useful during longer DCA swaps where the price of the asset is moving in favor of the swapper.
