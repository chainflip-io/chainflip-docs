...
It is recommended to encode Vault swaps using the SDK's method to [encode the Vault Swap data](./encode-vault-swap-data.mdx). However, some integrators might want to manually execute the smart contract call to initiate Vault Swaps.
