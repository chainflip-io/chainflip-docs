...
{<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Optional metadata for setting a [minimum accepted price](../../../swapping-basics#minimum-accepted-price-slippage-protection) for swaps through the deposit channel. This allows to
...
The optional `fillOrKillParams` object sets a [minimum accepted price](../../../swapping-basics#minimum-accepted-price-slippage-protection) for swaps triggered through the deposit channel.
