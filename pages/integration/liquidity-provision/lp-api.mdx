...
- The external chain the withdrawal address is for as a camel-case string, eg "Ethereum" or "Polkadot"
- The withdraw address. The format depends on which external chain the address is for, eg ss58 encoding for "Polkadot" withdrawal addresses 
