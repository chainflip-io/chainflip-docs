...
<Callout type="info">
  If you haven't yet, make sure you read [How Swapping
  Workds](../../how-swapping-works.md) and [Swapping
  Basics](../../swapping-basics.md) to better understand how to execute your
  first swap.
</Callout>
