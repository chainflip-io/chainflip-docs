...
{<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        <code>boostFeeBps</code><span class="param-optional-label">(optional)</span>
      </td>
      <td>
        Fee in basis points that will be extracted from the deposit amount in case of a boosted deposit on the channel. Defaults to 0.
      </td>
...
```json
{
  ...
  "boostFeeBps": 0, // Commission charged by the broker for this swap 
