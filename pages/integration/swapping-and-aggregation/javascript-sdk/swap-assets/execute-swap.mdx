...
#### Uses smart contract calls to execute a swap
...
<Callout type="info">
  Learn more about direct Vault calls in
  [how-swapping-works.md](../../how-swapping-works.md "mention")
</Callout>
...
The resulting `transactionHash` can be used in [Get Status](../get-status.md "mention").
