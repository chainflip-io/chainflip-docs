...
Anyone looking to integrate Chainflip **must implement the Solidity function signature** below on the destination address. See [EVM implementation](../../EVM-implementation.mdx "mention") for more details.
