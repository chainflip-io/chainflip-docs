...
```json
{
  ...
  "quote": {
    ...
    "includedFees": [
      { "type": "INGRESS", "chain": "Ethereum", "asset": "ETH", "amount": "2000000" },
      { "type": "NETWORK", "chain": "Ethereum", "asset": "USDC", "amount": "2000000" },
      { "type": "BROKER", "chain": "Ethereum", "asset": "ETH", "amount": "4500000000000000" },
      { "type": "EGRESS", "chain": "Bitcon", "asset": "BTC", "amount": "20000" }
    ],
    ...
    "poolInfo": [
      {
        ...
        "fee": { "chain": "Ethereum", "asset": "ETH", "amount": "15000000000000000" }
      },
      {
        "baseAsset": { "chain": "Bitcoin", "asset": "BTC" },
        "quoteAsset": { "chain": "Ethereum", "asset": "USDC" },
        "fee": { "chain": "Ethereum", "asset": "USDC", "amount": "2000000" }
      }
    ]
  }
}
