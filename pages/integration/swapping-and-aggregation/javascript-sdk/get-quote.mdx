...
```json copy
{
  ...
  "quote": {
    "intermediateAmount": "995988718", // 995.98 USDC
    "egressAmount": "1030958949587320610", // 1.03 ETH
    "includedFees": [
      {
        "type": "INGRESS",
        "chain": "Bitcoin",
    ...
    "boostQuote": {
      "intermediateAmount": "995495652", // 995.49 USDC
      "egressAmount": "1030453715233730193", // 1.03 ETH
      "includedFees": [
        {
          "type": "BOOST",
          "chain": "Bitcoin",
