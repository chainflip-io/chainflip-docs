...
<Callout type="info">
  Learn more about the [Native Swap Flow](../../concepts/swaps-amm/native-swap-flow).
</Callout>
...
<Callout type="info">
  Learn more about our novel [Just In Time AMM Protocol](../../concepts/swaps-amm/just-in-time-amm-protocol).
</Callout>
