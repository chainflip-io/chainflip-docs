...
<Callout type="info">
  Learn more in [Just In Time AMM
  Protocol](http://127.0.0.1:5000/s/DQUC2wQf4NIhgIHFhCFR/swaps-amm/just-in-time-amm-protocol
  "mention")
</Callout>
...
<Callout type="info">
  Learn more in [$USDC Denominated
