...
- `boost_fee`: (Optional) Boost fee in basis points (100th of a percent).
- `affiliate_fees`: (Optional) Array of Beneficiaries (Up to 5).

Where Beneficiary is defined as follow: 
```json copy 
{
	account: AccountId, 
	bps: BasisPoints,
