...
Broker operators can choose to charge a fee for the use of their endpoint. The fee is denominated in basis points, where a basis point is defined as 1/100th of a percentile and limited to 1000 basis points (equivalent to 10%). This fee is taken in the deposit asset and credited to the broker's account.
