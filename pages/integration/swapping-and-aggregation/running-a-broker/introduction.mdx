...
1. Any _State Chain_ account can register as a Broker, and start submitting **Deposit Channel Requests** extrinsics on users' behalf.
...
3. Brokers must pay a small transaction fee in \$FLIP for each extrinsic they submit and a "Channel Fee". This is to avoid spam and for integrity reasons. The suggested amount to fund the State Chain account is 10 \$FLIP. 
