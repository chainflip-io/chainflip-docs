...
Once registered, the account will have full access to broker-related actions through the [Broker API](/integration/swapping-and-aggregation/running-a-broker/broker-api).
