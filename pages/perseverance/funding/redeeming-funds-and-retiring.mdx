...
If for some reason, you can't finish the redemption process, your redemption certificate will eventually expire. This means you will need to refund your `tFLIP` back to your State Chain balance, before starting a new redemption process.
