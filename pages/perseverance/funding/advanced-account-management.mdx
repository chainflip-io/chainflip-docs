...
In case of Restricted addresses the limitation of [Redeem Address Binding](./advanced-account-management#redeem-address-binding) and [Redemption Execution Address Binding](./advanced-account-management#redemption-execution-address-binding) are not applied, a restricted address will always be able to withdraw its funds.