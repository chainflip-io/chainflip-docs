...
<Callout type="warning">Currently we only support MetaMask Wallets.</Callout>
...
- **Send a message containing your Node Public Key and you wallet address. **<span style={{ color: "orange"}}>**You should have gotten this ID during the setup process in the**</span> [<span style={{ color: "orange"}}>**Generating Keys**</span>](../validator-setup/keys.md) <span style={{ color: "orange"}}>>**section of the docs**</span>
- **We will send you tFLIP after verifying you have setup a node.**

</Callout>

<Callout type="warning">
  **Remember to import the `tFLIP` Token using the address above in order for
  the assets to show up in your wallet. tFLIP Address:
...
<Callout type="info">
  ...
  <span style={{ color: "red" }}>**Offline**</span> state. Just wait for your
  node to sync all the blocks&#x20;
</Callout>
...
<span style={{color: "red"}}>**🚨 As a result of this you node will never become active and you'll be slashed and might lose all your tFLIP.**</span>
</Callout>
