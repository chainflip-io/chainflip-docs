...
<Callout type="info">
For Docker or Kubernetes users, see [here](#docker--kubernetes) for how to migrate your configuration file.
</Callout>
...
When upgrading using Docker or Kubernetes, you will have to create a separate configuration file for the new container version, using the new format. You can start the new version container with the new configuration file and it will sit idly until the runtime upgrade has occurred. Once the runtime upgrade has occurred, you can stop the old container.
