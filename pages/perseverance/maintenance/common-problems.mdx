...
The commands that were already runned successfully will fail with an error resembling the following:
<br />
<img src="/perseverance/validaotr_cli_commands_failing.png" alt="" />
<br />
