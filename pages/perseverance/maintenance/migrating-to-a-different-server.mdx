...
No problem, one of your amazing community members has developed this guide. After you have created a new machine and finished all the steps up to and including [Creating new linux users](../validator-setup/creating-new-linux-user.md "mention"), follow this guide.
...
<Callout type="error">
  **WARNING** :atom: Do not run two instances of your Validator at the same
  time. You will almost certainly be slashed. Make sure you turn off your old
  server before you turn on your new one.
</Callout>
...
[Engine Settings](../validator-setup/engine-settings.md)

Then start the node and engine services as explained here:&#x20;

[Start up](../validator-setup/installation-pt2.md)
