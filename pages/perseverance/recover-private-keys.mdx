...
<Callout type="error" emoji="⛔️">
 All the information you get back when running any of the commands below is private sensitive data. **Do not share it with anyone. ⛔️**

<span style={{ color:"red"}}>**Whoever has access to these keys can take all your tFLIP added to your validator node.**</span>
</Callout>
...
This command will return the private key of your node and other keys. <span style={{ color:"red"}}>**DO NOT share this with anyone.**</span>

Chainflip <span style={{ color:"red"}}>**will never**</span> ask you to reveal these keys under any circumstances.
