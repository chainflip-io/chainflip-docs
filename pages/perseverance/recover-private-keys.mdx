...
<Callout type="error">
All the information you get back when running any of the commands below is private sensitive data.
**Do not share it with anyone. Whoever has access to these keys can take all your tFLIP added to your validator node**
</Callout>
