...
If you only use the configuration file, and *not* environment or command line arguments, then you can skip this section if your upgrade to 0.10.0 was successful, as the migration of the configuration file should be done automatically.
