...
- [`executor_address`](#addresses) (Optional): Restricts the `executeRedemption` function call in the [Gateway contract](../../concepts/validator-network/state-chain-flip-gateway.md#the-gateway "mention") to only be callable by the specified address for this redemption. If not specified, anyone can execute the redemption.
