...
- Rivet - `wss://SOME_LONG_SECRET_INFORMATION.ETH_NETWORK.ws.rivet.cloud`
- Infura - `wss://ETH_NETWORK.infura.io/ws/v3/SOME_LONG_SECRET_INFORMATION`
- Alchemy - `wss://eth-ETH_NETWORK.g.alchemy.com/v2/SOME_LONG_SECRET_INFORMATION`
...
Foem Mainnet validators, make sure to point your rngine to mainnet RPCs for Ethereum, Polkadot and Bitcoin.
...
<Callout type="info">
  ...
  (and most reliable) endpoint you have i.e. a local geth node to lower lower
...
## Pointing to RPC Clients

<Callout type="warning">
  **Important:** Make sure you are pointing to the right network (mainnet, testnet, etc.) for your validator. If you use the wrong network, your validator will fail to witness events.
</Callout>

We recommend running your own RPC nodes for all networks Chianflip supports to ensure maximum reliability and uptime. However, if you don't want to run your own nodes, you can use a third-party RPC provider.

- Etherum: [Alchemy](https://www.alchemy.com/), [Infura](https://infura.io/), [Rivet](https://rivet.cloud/)
- Polkadot & Bitcoin: [OnFinality](https://onfinality.io/), [GetBlock](https://getblock.io/)
