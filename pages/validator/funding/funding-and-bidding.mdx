...
## Getting tFLIP (Perseverance Testnet Only)
...
The current amount of `tFLIP` required to become an Active Validator can be checked on the [Chainflip testnet Auctions page](https://auctions-perseverance.chainflip.io/) or in the [Chainflip Mainner Auctions page](https://auctions.chainflip.io/).

<Callout type="info">
  `tFLIP` is an ERC20 token on the Ethereum Goerli Testnet.\
  [0x0485D65da68b2A6b48C3fA28D7CCAce196798B94](https://goerli.etherscan.io/address/0x0485D65da68b2A6b48C3fA28D7CCAce196798B94)
</Callout>
...
## Berghain Mainnet Contracts

### FLIP Token

<Callout type="warning">
  Remember to import the `FLIP` Token using this address in order for the
  assets to show up in your wallet:
  **0x826180541412D574cf1336d22c0C0a287822678A**
</Callout>

Contract Address on Ethereum: [`0x826180541412D574cf1336d22c0C0a287822678A`](https://etherscan.io/address/0x826180541412D574cf1336d22c0C0a287822678A)
...
2. Go to [Chainflip Auctions page](https://auctions-perseverance.chainflip.io/) > "**My Nodes**" (For mainnet use [Chainflip Mainnet Auctions page](https://auctions.chainflip.io/))
...
```bash copy
sudo systemctl restart chainflip-engine1.0
```
